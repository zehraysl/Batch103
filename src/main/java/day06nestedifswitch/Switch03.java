...
public class Switch03 {
    public static void main(String[] args) {
        ...
        //not:switch'de sadece int.byte,short,char,String data tipleri kullanilir,
        //not: eger 3'ten fazla durum varsa switch() tercih ederim.
        //Kullanicidan islem ve iki tane sayi alarak islemin sonucunu ekrana yazdiran
        //  basit bir hesap makinasi yapiniz.
